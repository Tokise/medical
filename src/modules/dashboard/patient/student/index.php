            ...
            <div class="dashboard-column">
                ...
                <div class="health-record-section">
                    <div class="section-header">
                        ...
                        <a href="/medical/src/modules/dashboard/patient/health-records/view.php" class="btn btn-primary">View Full Record</a>
                    </div>
            ...
            <div class="dashboard-column">
                ...
                <div class="quick-actions-section">
                    ...
                    <div class="quick-actions">
                        ...
                        <a href="/medical/src/modules/dashboard/patient/health-records/view.php" class="action-card">
                            <div class="action-icon">
