...
// Check if the user is a doctor, if not redirect to appropriate dashboard
...
function get_today_appointments($doctor_id) {
    ...
    $sql = "SELECT COUNT(*) as total FROM appointments WHERE doctor_id = ? AND appointment_date = CURDATE()";
...
$today_appointments = get_today_appointments($doctor_id);
    ...
    <div class="doctor-dashboard">
        ...
        <div class="stats-grid">
            <div class="stat-card">
                ...
                <h2 class="stat-value"><?php echo $today_appointments; ?></h2>
            ...
            <div class="col-lg-8">
                <div class="activity-section">
                    <div class="section-header">
                        ...
                        <a href="../../appointment/doctor-schedule.php" class="btn btn-primary btn-sm">View All</a>
                    </div>
                        ...
                        <table class="data-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="../../appointment/view.php?id=<?php echo $appointment['id']; ?>" class="btn btn-sm btn-outline"><i class="fas fa-eye"></i></a>
                                        <a href="../../consultation/start.php?appointment_id=<?php echo $appointment['id']; ?>" class="btn btn-sm btn-primary"><i class="fas fa-stethoscope"></i></a>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
                                <?php else: ?>
            ...
            <div class="col-lg-4">
                ...
                <div class="activity-section">
                    ...
                    <div class="quick-actions">
                        <a href="../../consultation/list.php" class="action-card">
                            <div class="action-icon">
                                <i class="fas fa-stethoscope"></i>
                            </div>
                            <h4 class="action-title">View Consultations</h4>
                            <p class="action-description">Manage patient consultations</p>
                        </a>
                        <a href="../../prescription/create.php" class="action-card">
                            <div class="action-icon">
                                <i class="fas fa-prescription"></i>
                            </div>
                            <h4 class="action-title">Create Prescription</h4>
                            <p class="action-description">Write a new prescription</p>
                        </a>
                        <a href="../../records/create.php" class="action-card">
                            <div class="action-icon">
                                <i class="fas fa-file-medical"></i>
                            </div>
                            <h4 class="action-title">New Medical Record</h4>
                            <p class="action-description">Create a new medical record</p>
                        </a>
                        <a href="../../appointment/doctor-schedule.php" class="action-card">
                            <div class="action-icon">
                                <i class="fas fa-calendar-alt"></i>
                            </div>
                            <h4 class="action-title">Manage Schedule</h4>
                            <p class="action-description">View and update your schedule</p>
                        </a>
                    </div>
                </div>
            </div>
